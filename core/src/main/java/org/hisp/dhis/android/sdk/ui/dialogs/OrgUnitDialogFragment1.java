...
public class OrgUnitDialogFragment1 extends AutoCompleteDialogFragment
        implements LoaderManager.LoaderCallbacks<OrgUnitDialogFragmentForm> {
    public static final int ID = 450124;
    private static final int LOADER_ID = 1;
    private static final String PROGRAMTYPE = "programType";

    public static OrgUnitDialogFragment1 newInstance(OnOptionSelectedListener listener,
                                                     ProgramType... programKinds) {
        OrgUnitDialogFragment1 fragment = new OrgUnitDialogFragment1();
    ...
    public static OrgUnitDialogFragment1 newInstance1(OnOptionSelectedListener listener,
                                                      ProgramType... programKinds) {
        OrgUnitDialogFragment1 fragment = new OrgUnitDialogFragment1();
        Bundle args = new Bundle();
        if (programKinds != null) {
