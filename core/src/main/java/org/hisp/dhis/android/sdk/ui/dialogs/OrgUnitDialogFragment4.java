...
public class OrgUnitDialogFragment4 extends AutoCompleteDialogFragment
        implements LoaderManager.LoaderCallbacks<OrgUnitDialogFragmentForm> {
    public static final int ID = 450127;
   ...
   public String orgId="kk";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "onCreate: 4th" + orgId);
    }

    public static OrgUnitDialogFragment4 newInstance(OnOptionSelectedListener listener,
                                                     ProgramType... programKinds) {

        OrgUnitDialogFragment4 fragment = new OrgUnitDialogFragment4();
...
//                    .getAssignedOrganisationUnits();
            ...
            return MetaDataController
                    .getorganisationUnitsLevelWise(9);
        }
